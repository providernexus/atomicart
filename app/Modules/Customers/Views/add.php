				...
				<div class="card-body">
                   ...
                   <!-- <?php if (!empty($errors)) : ?>
                        ...
                        <div class="row">
                        	...
                        	<div class="col-md-4">
                        		<div class="form-group">
                        			<label for="password"><?php echo lang('Text.customer.table.label.password') ?><span class="favor_in_span">*</span></label>
                        	...
                        	<div class="col-md-4">
                        		<div class="form-group">
                        			...
                        			<input type="text" class="form-control" name="phone" value="<?php echo set_value('phone') ?>" autocomplete="off" />
                        	...
                        	<div class="col-md-4">
                        		<div class="form-group">
                        			...
                        			<input class="form-control" name="dob" id="datepicker" value="<?php echo set_value('dob') ?>" >
