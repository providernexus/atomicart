						...
						<table class="table" id="table" data-show-toggle="true" data-show-columns="true" data-show-columns-toggle-all="true" data-minimum-count-columns="2" data-reorderable-columns="true" data-resizable="true" data-buttons="buttons">
							...
							<tbody>
								<?php if ($results) :
									...
									$department =$modal->GetSingleValue('tbl_department','title',array('id' => $result['department']));
									$sub_department = $modal->GetSingleValue(DEPARTMENT_TABLE, 'title', array('id' => $result['sub_department']));
									...
									if(!empty($result['type'])):
										$type = type_department($result['type']);
									endif;
								...
								<tr>
									...
									<td class="descri"><?php echo $sub_department ?>
									</td>
									...
									<!--<td><label class="switch"><input class="check_category_status" value="<?//=$result['status'] ?>" type="checkbox" <?//php if($result['status']==1){echo 'checked';};?> data-id="<?//=$result['id'] ?>"><span class="slider round"></label></td>-->
