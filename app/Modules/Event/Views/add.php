					...
					<div class="row">
                       ...
                       <div class="col-md-4">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="start_date" id="start_date" value="<?php echo set_value('start_date') ?>" />
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="end_date" id="end_date" value="<?php echo set_value('end_date') ?>" />
								<i class="mdi mdi-calendar" id="show-date-picker"></i>
							</div>
						</div>
						<div class="col-md-12">
