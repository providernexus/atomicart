...
namespace Modules\Reels\Controllers;
...
class AdminController extends BaseController
{
	...
	public function __construct()
	{
		...
		$this->module = "Manage Reels";
		$this->fp = '\Modules\Reels\Views';
		$this->default_table = REELS_TABLE;
        $this->mr = "reels"; // Module route
    }
    ...
    public function index()
    {
    	...
    	$page_data['module'] = 'Manage Department';
