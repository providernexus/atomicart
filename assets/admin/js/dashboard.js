function initChart(labels_arr,monthly_value){
...
function monthlyCustomers(labels_arr,customers_value){
	if ($("#sales-charts").length) {
	  ...
	  var revenueChartCanvas = $("#sales-charts").get(0).getContext("2d");
	  var revenueChart = new Chart(revenueChartCanvas, {
		type: 'line',
		data: areaData,
		options: areaOptions
...
function skip_traced_chart(labels_arr,skip_traced_value,verified_by_values){
	if ($("#skip_verified").length) {
	  var areaData = {
		labels: labels_arr,
		datasets: [
		  {
			data: skip_traced_value,
			borderColor: [
			  '#4747A1'
			],
			borderWidth: 2,
	  ...
	  var revenueChartCanvas = $("#skip_verified").get(0).getContext("2d");
	  var revenueChart = new Chart(revenueChartCanvas, {
		type: 'line',
		data: areaData,
		options: areaOptions
...
/* function skip_traced_chart(labels_arr, skip_traced_value, verified_by_values) {
	alert('sd');
  if ($("#skip_verified").length) {
    var SalesChartCanvas = $("#skip_verified").get(0).getContext("2d");
